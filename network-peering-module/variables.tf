...
variable "export_peer_custom_routes" {
  ...
  type        = bool
  //default     = false
  default = "https://www.googleapis.com/compute/v1/projects/spatial-lock-338613/mynetwork-001"
}
...
variable "export_local_custom_routes" {
  ...
  type        = bool
  //default     = false
  default = "https://www.googleapis.com/compute/v1/projects/myproject112345/mynetwork-002"
}
